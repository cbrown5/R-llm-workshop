...
Let's put together what we've learnt so far and built our own chatbot. I've provided you with a detailed system prompt that implements a chat bot that specialises in helping with statistics. First, 

```{r, eval=FALSE}

stats_bot <- readLines("resources/DIY-stats-bot-system.md")
...
chat_stats$chat("Use stats mode to provide me with some suggestions for how I could make a predictive model of a variable y, where I have a large number of potential explanatory variables. ")
chat_stats$chat("y is integer count data")
```
